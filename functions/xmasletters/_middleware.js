...
function escapeHtml(str){const div={innerHTML:''};div.textContent=str;return div.innerHTML}

function letterHTML(id,content){
  let body='<div class="letter-icon">🎄</div>';
...
export async function onRequest(context){
  ...
  try{
    ...
    let content=null;
    const rawContent=await env.XMAS_CONTENT.get(pageId);
    if(rawContent){
