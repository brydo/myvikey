...
function letterHTML(id, content) {
  ...
  if (content && content.text) {
    body += '<h1>A Personal Christmas Message Just For You</h1><div class="letter-text">' + escapeHtml(content.text) + '</div>';
  }
